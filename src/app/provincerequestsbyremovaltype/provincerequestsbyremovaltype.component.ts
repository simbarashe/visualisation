...
@Component({
  selector: 'app-provincerequestsbyremovaltype',
  templateUrl: './provincerequestsbyremovaltype.component.html',
  styleUrls: ['./provincerequestsbyremovaltype.component.scss']
})
export class ProvincerequestsbyremovaltypeComponent implements OnInit {
